# setwd("Z:\\RusynLab\\Cell Culture Lab\\Concawe Screening\\iPSC cardiomyocytes\\R Processing\\Peak Frequency - 24 hrs")
setwd("C:\\4_R\\Demonstration\\Peak_frequency-24hr")
if(file.exists(".\\Figs\\Peak_freq_24hr1.png")){
	quit()}
...
#for (i in (1:numchem)){
# pdf("PF_24hrs.pdf",height=5,width=5)
for (i in (1:numchem)){ 
	file_name = paste(".\\Figs\\Peak_freq_24hr", i, ".png", sep="")
    	png(file_name)
...
#write.csv(final.df,"PF_24hrs_log10.csv")
write.csv(final.notlog10.df,"PF_24hrs_originalscale.csv")
