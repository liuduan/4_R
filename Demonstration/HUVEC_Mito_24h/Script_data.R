# setwd("E:\\Concawe Screening\\HUVECs\\R Processing\\Mito_24hr")
setwd("C:\\4_R\\Demonstration\\HUVEC_Mito_24h")
if(file.exists(".\\Figs\\HUVEC_Mito_24h1.png")){
...
#for (i in (1:numchem)){
# pdf("DRGraphs.pdf",height=5,width=5)
for (i in (1:numchem)){ 
	file_name = paste(".\\Figs\\HUVEC_Mito_24h", i, ".png", sep="")
    	png(file_name) 				##### These two lines need change
...
write.csv(final.df,"STATS_log10.csv")
write.csv(final.notlog10.df,"STATS_originalscale.csv")
