# setwd("E:\\Concawe Screening\\HUVECs\\R Processing\\TotTubArea_18hr")
setwd("C:\\4_R\\Demonstration\\HUVEC_tube_area")
if(file.exists(".\\Figs\\HUVEC_tube_area1.png")){
	quit()}
source("fitfunctions.txt")

#install.packages("pROC")s
library(pROC)
...
for (i in (1:numchem)){ 
    file_name = paste(".\\Figs\\HUVEC_tube_area", i, ".png", sep="")
    png(file_name) 
